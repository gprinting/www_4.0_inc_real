...
class Foil extends Afterprocess {
    ...
    function cost() {
        ...
        $size_area = $this->product->size_w * $this->product->size_h;
...
*/
    ...
    function getAfterList() {
        ...
        //echo $this->depth1;
        $ret["depth2"]     = $this->depth1_dvs;
        $ret["depth3"]     = "-";
        $ret["basic_yn"]     = "N";
        $ret["detail"]     = $this->depth1 . "(" . $this->depth1_wid . "mm x " . $this->depth1_vert . "mm " .$this->depth1_dvs .")";
